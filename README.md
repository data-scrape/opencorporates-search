...
**Opencorporates** — OpenCorporates Search - Structure public company registry results for business research

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/opencorporates-search?style=social)
...
>
> **Search intent:** collect public OpenCorporates data for account research, CRM enrichment, and lead qualification. Related topics: company registry, business data, public records, python, data extraction.

## What this project is for

`opencorporates-search` is an implementation-focused Python project for collecting public OpenCorporates data. It is designed around one practical job: turn a query such as **"B2B SaaS companies"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/opencorporates-search.git
cd opencorporates-search
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "OpenCorporates", "category": "Business Data Scrapers"}
  }
}
```
